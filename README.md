...
![3DLayout](/layout-doc-imgs/3DLayout.jpg)


Ezzing 3DLayout technical documentation - July 2016 - First Draft


**Table of Contents**  *generated with [DocToc](https://github.com/thlorenz/doctoc)*

- [Ezzing 3DLayout](#markdown-header-ezzing-3dlayout)
- [Screenshots](#markdown-header-screenshots)
- [3DLayout Interface](#markdown-header-3dlayout-interface)
    - [Aside Panel](#markdown-header-aside-panel)
    - [Canvas Area](#markdown-header-canvas-area)
        - [Buildings Index](#markdown-header-buildings-index)
        - [Main Options](#markdown-header-main-options)
        - [Control Buttons](#markdown-header-control-buttons)
- [Integration in a non-angular platform](#markdown-header-integration-in-a-non-angular-platform)
    - [HTML code](#markdown-header-html-code)
        - [DOM header](#markdown-header-dom-header)
        - [DOM body](#markdown-header-dom-body)
    - [Javascript code](#markdown-header-javascript-code)
- [3DLayout Communication System](#markdown-header-3dlayout-communication-system)
    - [Info Events sent by 3DLayout](#markdown-header-info-events-sent-by-3dlayout)
        - [load](#markdown-header-load)
        - [zoomChanged](#markdown-header-zoomchanged)
        - [fullscreen](#markdown-header-fullscreen)
        - [tabChanged](#markdown-header-tabchanged)
        - [editArea](#markdown-header-editarea)
        - [editKeepout](#markdown-header-editkeepout)
        - [editTree](#markdown-header-edittree)
        - [areaChanged](#markdown-header-areachanged)
        - [buildingChanged](#markdown-header-buildingchanged)
        - [editRoof](#markdown-header-editroof)
        - [editVertices](#markdown-header-editvertices)
        - [buildingRemoved](#markdown-header-buildingremoved)
        - [buildingSelected](#markdown-header-buildingselected)
        - [buildingCreated](#markdown-header-buildingcreated)
    - [Functions to retrieve info from 3DLayout](#markdown-header-functions-to-retrieve-info-from-3dlayout)
        - [Generic Functions](#markdown-header-generic-functions)
            - [getCurrentBuildingId](#markdown-header-getcurrentbuildingid)
            - [getLayoutData](#markdown-header-getlayoutdata)
            - [getNumberOfModules](#markdown-header-getnumberofmodules)
            - [getTotalPower](#markdown-header-gettotalpower)
            - [getPower](#markdown-header-getpower)
        - [Building related functions](#markdown-header-building-related-functions)
            - [getBuildingInfo](#markdown-header-getbuildinginfo)
            - [getRoofInfo](#markdown-header-getroofinfo)
            - [getBuildingPosition](#markdown-header-getbuildingposition)
        - [Area related functions](#markdown-header-area-related-functions)
            - [getAreaInfo](#markdown-header-getareainfo)
            - [getModuleInfoByArea](#markdown-header-getmoduleinfobyarea)
            - [getModulesSructureByArea](#markdown-header-getmodulessructurebyarea)
            - [getAreaOffset](#markdown-header-getareaoffset)
- [Layout Rules](#markdown-header-layout-rules)
    - [Special Behaviours](#markdown-header-special-behaviours)
        - [Display](#markdown-header-display)
        - [zoom](#markdown-header-zoom)
        - [logo](#markdown-header-logo)
    - [Default Values](#markdown-header-default-values)
        - [modules](#markdown-header-modules)
        - [DefaultRoofs](#markdown-header-defaultroofs)
        - [DefaultBuilding](#markdown-header-defaultbuilding)
        - [CustomPalette](#markdown-header-custompalette)
    - [Custom Buttons](#markdown-header-custom-buttons)
        - [MainoptionsCustomButtons](#markdown-header-mainoptionscustombuttons)
        - [ControlCustomButtons](#markdown-header-controlcustombuttons)
...
|     |       |
| --- | ----- |
|  ![perspective view](/layout-doc-imgs/perspective-view.jpg)   |    ![sun simulation](/layout-doc-imgs/sun-simulation.jpg)   |
...
|     |       |     |
| --- | ----- | --- |
| ![tab building](/layout-doc-imgs/tab-building.jpg)    |  ![tab areas 1](/layout-doc-imgs/tab-areas-1.jpg)     |   ![tab areas 2](/layout-doc-imgs/tab-areas-2.jpg)  |
|  ![tab keepouts](/layout-doc-imgs/tab-keepouts.jpg)   |  ![tab trees](/layout-doc-imgs/tab-trees.jpg)     |     |
...
> Please, visit the section [Custom Buttons](#markdown-header-custom-buttons) to learn how to add your own functions.
...
![controlbuttons](/layout-doc-imgs/controlbuttons.jpg)
