...
gs -dBATCH -dNOPAUSE -q -sDEVICE=pdfwrite -sOutputFile=./3DLayout-doc-temp.pdf ./doc_templates/portada.pdf ./3DLayout-doc.pdf
gs -dBATCH -dNOPAUSE -q -sDEVICE=pdfwrite -sOutputFile=./3DLayout-doc-2.10.0.pdf ./3DLayout-doc-temp.pdf ./doc_templates/contraportada.pdf
rm ./3DLayout-doc.pdf
