...
pandoc -f gfm-smart -t html5 --include-in-header=./doc_templates/fonts.js --toc --include-in-header=./doc_templates/header_toc-userDoc.html --css pandoc.css --metadata title="3DLayout Documentation for users" -o README-userDoc.html 1-Introduction-userDoc.md 5-changelog.md
