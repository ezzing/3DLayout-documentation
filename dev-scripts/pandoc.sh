# For instalators
pandoc -f gfm -t html5 --include-in-header=./doc_templates/fonts.js --css ./doc_templates/pandoc.css --metadata title="3DLayout Documentation for users" -o doc-userDoc.html 1-Introduction.md 5-changelog.md
